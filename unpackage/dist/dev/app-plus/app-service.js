(function(vue) {
  ...
  const _sfc_main$2 = /* @__PURE__ */ vue.defineComponent({
    setup(__props) {
      ...
      vue.onMounted(() => {
        title.value = "\u6807\u9898";
        formatAppLog("log", "at pages/index/index.vue:41", "\u751F\u547D\u5468\u671F");
      });
      const handle = () => {
        formatAppLog("log", "at pages/index/index.vue:44", "\u6267\u884C\u70B9\u51FB\u4E8B\u4EF6");
        num.value++;
        formatAppLog("log", "at pages/index/index.vue:47", "num", num.value);
      };
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", { class: "content" }, [
          ...
          vue.createElementVNode("text", null, vue.toDisplayString(vue.unref(num)), 1),
          vue.createElementVNode("button", {
            type: "default",
            onClick: handle
          }, "\u6D4B\u8BD5\u70B9\u51FB\u4E8B\u4EF6"),
          vue.createVNode(_component_van_tabbar, {
            modelValue: vue.unref(active),
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => vue.isRef(active) ? active.value = $event : active = $event),
            onChange
          }, {
            default: vue.withCtx(() => [
              vue.createVNode(_component_van_tabbar_item, { icon: "home" }, {
                default: vue.withCtx(() => [
                  vue.createTextVNode("Overview")
                ]),
                _: 1
              }),
              vue.createVNode(_component_van_tabbar_item, { icon: "traffic" }, {
                default: vue.withCtx(() => [
                  vue.createTextVNode("Traffic")
                ]),
                _: 1
              }),
              vue.createVNode(_component_van_tabbar_item, { icon: "store" }, {
                default: vue.withCtx(() => [
                  vue.createTextVNode("Store")
                ]),
                _: 1
              }),
              vue.createVNode(_component_van_tabbar_item, { icon: "account" }, {
                default: vue.withCtx(() => [
                  vue.createTextVNode("Account")
                ]),
                _: 1
              })
            ]),
  ...
  const _sfc_main$1 = /* @__PURE__ */ vue.defineComponent({
    setup(__props) {
      ...
      const onChange = (e) => {
        if (e == 0) {
          uni.navigateTo({
            url: `/pages/index/index?index=${e}`
          });
        } else if (e == 1) {
          uni.navigateTo({
            url: `/pages/traffic/index?index=${e}`
          });
        }
      };
      onShow((a) => {
        active.value = options;
        formatAppLog("log", "at pages/traffic/index.vue:34", a);
      });
      return (_ctx, _cache) => {
        const _component_van_tabbar_item = vue.resolveComponent("van-tabbar-item");
        const _component_van_tabbar = vue.resolveComponent("van-tabbar");
  ...
  __definePage("pages/index/index", _sfc_main$2);
  __definePage("pages/traffic/index", _sfc_main$1);
  const _sfc_main = {
    onLaunch: function() {
  ...
  const MAIN_HOST = "https://app-api.iyouya.com";
        ...
        if (res.statusCode != 200) {
          ...
          if (res.statusCode == 401) {
            uni.redirectTo({
              ...
              fail(err2) {
                formatAppLog("log", "at utils/request.js:35", err2);
              }
            });
          }
          reject(res);
  ...
  var stdin_default$1m = vue.defineComponent({
    ...
    setup(props, {
      ...
      {
        if (slots.default) {
          formatAppLog("warn", "at node_modules/vant/es/picker/Picker.js:38", '[Vant] Picker: "default" slot is deprecated, please use "toolbar" slot instead.');
        }
        if (props.valueKey) {
          formatAppLog("warn", "at node_modules/vant/es/picker/Picker.js:41", '[Vant] Picker: "valueKey" prop is deprecated, please use "columnsFieldNames" prop instead.');
        }
      }
  ...
  Toast.install = (app) => {
    app.use(withInstall(stdin_default$1h));
    ...
    setup(props, {
      ...
      var _a, _b;
      {
        ...
        if (props2 && "onClick" in props2) {
          formatAppLog("warn", "at node_modules/vant/es/tabs/Tabs.js:50", '[Vant] Tabs: "click" event is deprecated, using "click-tab" instead.');
        }
        if (props2 && "onDisabled" in props2) {
          formatAppLog("warn", "at node_modules/vant/es/tabs/Tabs.js:53", '[Vant] Tabs: "disabled" event is deprecated, using "click-tab" instead.');
        }
      }
      let tabHeight;
      let lockScroll;
      ...
      const renderNav = () => children.map((item, index) => vue.createVNode(stdin_default$10, vue.mergeProps({
        "id": `${id}-${index}`,
      ...
      return () => {
        ...
        }) : [renderHeader(), (_a2 = slots["nav-bottom"]) == null ? void 0 : _a2.call(slots)], vue.createVNode(stdin_default$_, {
  ...
  var stdin_default$Y = vue.defineComponent({
    ...
    setup(props, {
      ...
      if (!parent) {
        {
          formatAppLog("error", "at node_modules/vant/es/swipe-item/SwipeItem.js:25", "[Vant] <SwipeItem> must be a child component of <Swipe>.");
        }
        return;
      }
      const style = vue.computed(() => {
  ...
  var stdin_default$X = vue.defineComponent({
    ...
    setup(props, {
      ...
      if (!parent) {
        {
          formatAppLog("error", "at node_modules/vant/es/tab/Tab.js:36", "[Vant] <Tab> must be a child component of <Tabs>.");
        }
        return;
      }
      const getName = () => {
  ...
  function validateModelValue(modelValue, accordion) {
    if (accordion && Array.isArray(modelValue)) {
      formatAppLog("error", "at node_modules/vant/es/collapse/Collapse.js:17", '[Vant] Collapse: "v-model" should not be Array in accordion mode');
      return false;
    }
    if (!accordion && !Array.isArray(modelValue)) {
      formatAppLog("error", "at node_modules/vant/es/collapse/Collapse.js:21", '[Vant] Collapse: "v-model" should be Array in non-accordion mode');
      return false;
    }
    return true;
  }
  ...
  var stdin_default$O = vue.defineComponent({
    ...
    setup(props, {
      ...
      if (!parent) {
        {
          formatAppLog("error", "at node_modules/vant/es/collapse-item/CollapseItem.js:32", "[Vant] <CollapseItem> must be a child component of <Collapse>.");
        }
        return;
      }
  ...
  var stdin_default$A = vue.defineComponent({
    ...
    setup(props, {
      ...
      if (!parent) {
        {
          formatAppLog("error", "at node_modules/vant/es/dropdown-item/DropdownItem.js:39", "[Vant] <DropdownItem> must be a child component of <DropdownMenu>.");
        }
        return;
      }
  ...
  var stdin_default$x = vue.defineComponent({
    ...
    setup(props, {
      ...
      if (!parent) {
        {
          formatAppLog("error", "at node_modules/vant/es/grid-item/GridItem.js:32", "[Vant] <GridItem> must be a child component of <Grid>.");
        }
        return;
      }
      const rootStyle = vue.computed(() => {
  ...
  var stdin_default$v = vue.defineComponent({
    ...
    setup(props, {
      ...
      const renderImages = () => vue.createVNode(Swipe, {
        ...
        default: () => [props.images.map((image) => vue.createVNode(stdin_default$w, {
          "src": image,
          "show": props.show,
          "active": state.active,
  ...
  var stdin_default$t = vue.defineComponent({
    ...
    setup(props, {
      ...
      if (!parent) {
        {
          formatAppLog("error", "at node_modules/vant/es/index-anchor/IndexAnchor.js:34", "[Vant] <IndexAnchor> must be a child component of <IndexBar>.");
        }
        return;
      }
    ...
    setup(props, {
      ...
      const renderSidebar = () => {
        if (props.theme === "custom") {
          return vue.createVNode("div", {
            "class": bem$l("sidebar")
          }, [props.showDeleteKey && vue.createVNode(stdin_default$o, {
            "large": true,
            ...
            delete: slots.delete
          }), vue.createVNode(stdin_default$o, {
            "large": true,
      ...
      Object.keys(modifier).forEach(function(key) {
        switch (key) {
          case "name":
            if (typeof modifier.name !== "string") {
              formatAppLog("error", "at node_modules/@vant/popperjs/dist/esm/index.js:393", format(INVALID_MODIFIER_ERROR, String(modifier.name), '"name"', '"string"', '"' + String(modifier.name) + '"'));
            }
            break;
          case "enabled":
            if (typeof modifier.enabled !== "boolean") {
              formatAppLog("error", "at node_modules/@vant/popperjs/dist/esm/index.js:400", format(INVALID_MODIFIER_ERROR, modifier.name, '"enabled"', '"boolean"', '"' + String(modifier.enabled) + '"'));
            }
          case "phase":
            if (modifierPhases.indexOf(modifier.phase) < 0) {
              formatAppLog("error", "at node_modules/@vant/popperjs/dist/esm/index.js:405", format(INVALID_MODIFIER_ERROR, modifier.name, '"phase"', "either " + modifierPhases.join(", "), '"' + String(modifier.phase) + '"'));
            }
            break;
          case "fn":
            if (typeof modifier.fn !== "function") {
              formatAppLog("error", "at node_modules/@vant/popperjs/dist/esm/index.js:412", format(INVALID_MODIFIER_ERROR, modifier.name, '"fn"', '"function"', '"' + String(modifier.fn) + '"'));
            }
            break;
          case "effect":
            if (typeof modifier.effect !== "function") {
              formatAppLog("error", "at node_modules/@vant/popperjs/dist/esm/index.js:419", format(INVALID_MODIFIER_ERROR, modifier.name, '"effect"', '"function"', '"' + String(modifier.fn) + '"'));
            }
            break;
          case "requires":
            if (!Array.isArray(modifier.requires)) {
              formatAppLog("error", "at node_modules/@vant/popperjs/dist/esm/index.js:426", format(INVALID_MODIFIER_ERROR, modifier.name, '"requires"', '"array"', '"' + String(modifier.requires) + '"'));
            }
            break;
          case "requiresIfExists":
            if (!Array.isArray(modifier.requiresIfExists)) {
              formatAppLog("error", "at node_modules/@vant/popperjs/dist/esm/index.js:433", format(INVALID_MODIFIER_ERROR, modifier.name, '"requiresIfExists"', '"array"', '"' + String(modifier.requiresIfExists) + '"'));
            }
            break;
          case "options":
          case "data":
            break;
          default:
            formatAppLog("error", "at node_modules/@vant/popperjs/dist/esm/index.js:443", 'PopperJS: an invalid property has been provided to the "' + modifier.name + '" modifier, valid properties are ' + VALID_PROPERTIES.map(function(s) {
              return '"' + s + '"';
        ...
        modifier.requires && modifier.requires.forEach(function(requirement) {
          if (modifiers.find(function(mod) {
            ...
            formatAppLog("error", "at node_modules/@vant/popperjs/dist/esm/index.js:452", format(MISSING_DEPENDENCY_ERROR, String(modifier.name), requirement, requirement));
          }
        });
      });
    });
  ...
  function popperGenerator(generatorOptions) {
    ...
    return function createPopper2(reference, popper, options) {
      ...
      var instance2 = {
        ...
        setOptions: function setOptions(options2) {
          ...
          });
          {
            ...
            if (getBasePlacement(state.options.placement) === auto) {
              ...
              if (!flipModifier) {
                formatAppLog("error", "at node_modules/@vant/popperjs/dist/esm/index.js:644", ['Popper: "auto" placements require the "flip" modifier be', "present and enabled to work."].join(" "));
              }
            }
            ...
            if ([marginTop, marginRight, marginBottom, marginLeft].some(function(margin) {
              ...
              formatAppLog("warn", "at node_modules/@vant/popperjs/dist/esm/index.js:659", ['Popper: CSS "margin" styles cannot be used to apply padding', "between the popper and its reference element or boundary.", "To replicate margin, use the `offset` modifier, as well as", "the `padding` option in the `preventOverflow` and `flip`", "modifiers."].join(" "));
            }
          }
          runModifierEffects();
        ...
        forceUpdate: function forceUpdate() {
          ...
          if (!areValidElements(reference2, popper2)) {
            {
              formatAppLog("error", "at node_modules/@vant/popperjs/dist/esm/index.js:683", INVALID_ELEMENT_ERROR);
            }
            return;
          }
          state.rects = {
          ...
          for (var index = 0; index < state.orderedModifiers.length; index++) {
            {
              ...
              if (__debug_loops__ > 100) {
                formatAppLog("error", "at node_modules/@vant/popperjs/dist/esm/index.js:715", INFINITE_LOOP_ERROR);
                break;
              }
            }
            if (state.reset === true) {
      ...
      if (!areValidElements(reference, popper)) {
        {
          formatAppLog("error", "at node_modules/@vant/popperjs/dist/esm/index.js:758", INVALID_ELEMENT_ERROR);
        }
        return instance2;
      }
  ...
  function computeStyles(_ref4) {
    ...
    var _options$gpuAccelerat = options.gpuAcceleration, gpuAcceleration = _options$gpuAccelerat === void 0 ? true : _options$gpuAccelerat, _options$adaptive = options.adaptive, adaptive = _options$adaptive === void 0 ? true : _options$adaptive, _options$roundOffsets = options.roundOffsets, roundOffsets = _options$roundOffsets === void 0 ? true : _options$roundOffsets;
    {
      ...
      if (adaptive && ["transform", "top", "right", "bottom", "left"].some(function(property) {
        ...
        formatAppLog("warn", "at node_modules/@vant/popperjs/dist/esm/index.js:984", ["Popper: Detected CSS transitions on at least one of the following", 'CSS properties: "transform", "top", "right", "bottom", "left".', "\n\n", 'Disable the "computeStyles" modifier\'s `adaptive` option to allow', "for smooth transitions, or remove these properties from the CSS", "transition declaration on the popper element if only transitioning", "opacity or background-color for example.", "\n\n", "We recommend using the popper element as a wrapper around an inner", "element that can have any CSS property transitioned for animations."].join(" "));
      }
    }
    var commonStyles = {
  ...
  var stdin_default$d = vue.defineComponent({
    ...
    setup(props, {
      ...
      if (!parent) {
        {
          formatAppLog("error", "at node_modules/vant/es/sidebar-item/SidebarItem.js:31", "[Vant] <SidebarItem> must be a child component of <Sidebar>.");
        }
        return;
      }
      const onClick = () => {
  ...
  var stdin_default$9 = vue.defineComponent({
    ...
    setup(props, {
      ...
      if (!parent) {
        {
          formatAppLog("error", "at node_modules/vant/es/step/Step.js:19", "[Vant] <Step> must be a child component of <Steps>.");
        }
        return;
      }
  ...
  var stdin_default$4 = vue.defineComponent({
    ...
    setup(props, {
      ...
      if (!parent) {
        {
          formatAppLog("error", "at node_modules/vant/es/tabbar-item/TabbarItem.js:34", "[Vant] <TabbarItem> must be a child component of <Tabbar>.");
        }
        return;
      }
      const active = vue.computed(() => {
